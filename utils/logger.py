...
class Logger(object):
    ...
    def set_logfile(self, logfile_name):
        ...
        self.tb_logger = tb_logger.Logger(logdir=os.path.join(self.logging_dir, 'tensorboard'), flush_secs=2)
    ...
    def tb_log(self, dict_stats: dict, cur_epoch: int):
        for k,v in dict_stats.items():
            self.tb_logger.log_value(k,v,cur_epoch)
